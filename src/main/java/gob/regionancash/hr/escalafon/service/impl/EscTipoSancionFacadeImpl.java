...
public class EscTipoSancionFacadeImpl implements EscTipoSancionFacade{
    ...
    public List<SanctionType> load(int first, int pageSize, String sortField, Map<String, Object> filters) {
        ...
        String sql;
        ql.add(em.createQuery("SELECT o " + (sql="FROM EscTipoSancion o WHERE 1=1 "
    ...
    @Override
    public void edit(SanctionType entity) {
