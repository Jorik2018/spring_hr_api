...
public class EscTipoPersonalFacadeImpl implements EscTipoPersonalFacade{
    ...
    public List<EscTipoPersonal> load(int first, int pageSize, String sortField, Map<String, Object> filters) {
        ...
        String sql;
        ql.add(em.createQuery("SELECT o " + (sql="FROM EscTipoPersonal o WHERE 1=1 "
    ...
    @Override
    public void edit(EscTipoPersonal entity) {
