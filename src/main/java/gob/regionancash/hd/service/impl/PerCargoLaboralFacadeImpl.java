...
public class PerCargoLaboralFacadeImpl implements PerCargoLaboralFacade{
    ...
    public List<PerCargoLaboral> load(int first, int pageSize, String sortField, Map<String, Object> filters) {
        ...
        String sql;
        ql.add(em.createQuery("SELECT o " + (sql="FROM PerCargoLaboral o WHERE 1=1 "
    ...
    @Override
    public void edit(PerCargoLaboral entity) {
