...
public class OrgContratoFacadeImpl implements OrgContratoFacade{
    ...
    public List<OrgContrato> load(int first, int pageSize, String sortField, Map<String, Object> filters) {
        ...
        String sql;
        ql.add(em.createQuery("SELECT o " + (sql="FROM OrgContrato o WHERE 1=1 "
    ...
    @Override
    public void edit(OrgContrato entity) {
