...
public class PerCategoriaDocenteFacadeImpl implements PerCategoriaDocenteFacade{
    ...
    public List<PerCategoriaDocente> load(int first, int pageSize, String sortField, Map<String, Object> filters) {
        ...
        String sql;
        ql.add(em.createQuery("SELECT o " + (sql="FROM PerCategoriaDocente o WHERE 1=1 "
    ...
    @Override
    public void edit(PerCategoriaDocente entity) {
